# =====================================================================
# 02_analyse.R  -  analysis table (from 01) -> tidy result tables.
# Reads lsf_analysis_sample.rds, writes aggregate tbl_*.csv. No findings here.
# Run:  source("scripts/02_analyse.R")
# =====================================================================
